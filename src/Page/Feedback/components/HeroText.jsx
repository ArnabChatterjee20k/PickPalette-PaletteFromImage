...
export default function HeroText() {
  return (
    <div className="flex flex-col items-center gap-4 mx-auto py-6 text-center">
      <h2 className="text-4xl text-white font-extrabold leading-none tracking-tight md:text-5xl lg:text-6xl">
        Join the Conversation
      </h2>
      <p className="text-2xl md:text-3xl font-bold leading-none tracking-tight text-gray-300">
        Share Your{" "}
